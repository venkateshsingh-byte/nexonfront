                ...
                <div className="container">
                    ...
                    <div className="col-sm-7 left">
                        ...
                        <video width="100%" height={440} controls="">
                            <source src="/nexontest/assets/images/video.mp4" type="video/mp4" />
                            <source src="/nexontest/assets/images/video.ogg" type="video/ogg" />
                ...
                <div className="container">
                    ...
                    <div className="btm">
                        ...
                        <div className="col-sm-3">
                            ...
                            <a href="#">
                                <div className="image">
                                <Image src="/nexontest/assets/images/man01.webp" width={200} height={208} className="img-responsive" alt="Khartaram" />
                                </div>
                                <div className="title">
                        ...
                        <div className="col-sm-3">
                            ...
                            <a href="#">
                                <div className="image">
                                <Image src="/nexontest/assets/images/man01.webp" width={200} height={208} className="img-responsive" alt="Mundkur" />
                                </div>
                                <div className="title">
                                <p>Mr. Ajoy Mundkur</p>
                                </div>
                        ...
                        <div className="col-sm-3">
                            ...
                            <a href="#">
                                <div className="image">
                                <Image src="/nexontest/assets/images/man01.webp" width={200} height={208} className="img-responsive" alt="Praveen" />
                                </div>
                                <div className="title">
                        ...
                        <div className="col-sm-3">
                            ...
                            <a href="#">
                                <div className="image">
                                <Image src="/nexontest/assets/images/man01.webp" width={200} height={208} className="img-responsive" alt="Kundu" />
                                </div>
                                <div className="title">
                ...
                <div className="container">
                    ...
                    <div className="btm">
                        ...
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c01.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2"> 
                            <Image src="/nexontest/assets/images/c02.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c03.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c04.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c05.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c06.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c07.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c08.jpg" width={190} height={101} className="img-responsive"  alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c09.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c10.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c11.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c12.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        <div className="col-sm-2">
                            <Image src="/nexontest/assets/images/c13.jpg" width={190} height={101} className="img-responsive" alt="Kundu" />
                        </div>
                        </div>
                    </div>
                    </div>
            ...
            <section className="aboutus05 section-space">
                <div className="container">
                    ...
                    <div className="col-sm-5">
                        <div className="image">
                        {" "}
                        <Image src="/nexontest/assets/images/labimg.jpg" width={520} height={541} alt="Kundu" />
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="col-sm-5">
                        <div className="image">
                        {" "}
                        <Image src="/nexontest/assets/images/labimg02.jpg" width={520} height={514} alt="Kundu" />
                        </div>
                    </div>
                    <div className="col-sm-7">
                        <div className="hm info">
                    ...
                    <div className="col-sm-5">
                        <div className="image">
                        {" "}
                        <Image src="/nexontest/assets/images/labimg03.jpg" width={520} height={313} alt="Kundu" />
                        </div>
                    </div>
                    </div>
                </div>
